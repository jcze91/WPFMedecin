...
namespace mouham_cWpfMedecin.ServiceUser {
    ...
    public interface IServiceUser {
        ...
        mouham_cWpfMedecin.ServiceUser.User[] GetListUser();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetListUser", ReplyAction="http://tempuri.org/IServiceUser/GetListUserResponse")]
        System.Threading.Tasks.Task<mouham_cWpfMedecin.ServiceUser.User[]> GetListUserAsync();
        ...
        mouham_cWpfMedecin.ServiceUser.User GetUser(string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetUser", ReplyAction="http://tempuri.org/IServiceUser/GetUserResponse")]
        System.Threading.Tasks.Task<mouham_cWpfMedecin.ServiceUser.User> GetUserAsync(string login);
        ...
        bool AddUser(mouham_cWpfMedecin.ServiceUser.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/AddUser", ReplyAction="http://tempuri.org/IServiceUser/AddUserResponse")]
        System.Threading.Tasks.Task<bool> AddUserAsync(mouham_cWpfMedecin.ServiceUser.User user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceUserChannel : mouham_cWpfMedecin.ServiceUser.IServiceUser, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceUserClient : System.ServiceModel.ClientBase<mouham_cWpfMedecin.ServiceUser.IServiceUser>, mouham_cWpfMedecin.ServiceUser.IServiceUser {
        ...
        public mouham_cWpfMedecin.ServiceUser.User[] GetListUser() {
            return base.Channel.GetListUser();
        }
        
        public System.Threading.Tasks.Task<mouham_cWpfMedecin.ServiceUser.User[]> GetListUserAsync() {
            return base.Channel.GetListUserAsync();
        }
        
        public mouham_cWpfMedecin.ServiceUser.User GetUser(string login) {
            return base.Channel.GetUser(login);
        }
        
        public System.Threading.Tasks.Task<mouham_cWpfMedecin.ServiceUser.User> GetUserAsync(string login) {
            return base.Channel.GetUserAsync(login);
        }
        
        public bool AddUser(mouham_cWpfMedecin.ServiceUser.User user) {
            return base.Channel.AddUser(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddUserAsync(mouham_cWpfMedecin.ServiceUser.User user) {
