...
namespace mouham_cWpfMedecin.ServicePatient {
    ...
    public partial class Patient : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private mouham_cWpfMedecin.ServicePatient.Observation[] ObservationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public mouham_cWpfMedecin.ServicePatient.Observation[] Observations {
            get {
    ...
    public interface IServicePatient {
        ...
        mouham_cWpfMedecin.ServicePatient.Patient[] GetListPatient();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetListPatient", ReplyAction="http://tempuri.org/IServicePatient/GetListPatientResponse")]
        System.Threading.Tasks.Task<mouham_cWpfMedecin.ServicePatient.Patient[]> GetListPatientAsync();
        ...
        mouham_cWpfMedecin.ServicePatient.Patient GetPatient(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetPatient", ReplyAction="http://tempuri.org/IServicePatient/GetPatientResponse")]
        System.Threading.Tasks.Task<mouham_cWpfMedecin.ServicePatient.Patient> GetPatientAsync(int id);
        ...
        bool AddPatient(mouham_cWpfMedecin.ServicePatient.Patient user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/AddPatient", ReplyAction="http://tempuri.org/IServicePatient/AddPatientResponse")]
        System.Threading.Tasks.Task<bool> AddPatientAsync(mouham_cWpfMedecin.ServicePatient.Patient user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePatientChannel : mouham_cWpfMedecin.ServicePatient.IServicePatient, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePatientClient : System.ServiceModel.ClientBase<mouham_cWpfMedecin.ServicePatient.IServicePatient>, mouham_cWpfMedecin.ServicePatient.IServicePatient {
        ...
        public mouham_cWpfMedecin.ServicePatient.Patient[] GetListPatient() {
            return base.Channel.GetListPatient();
        }
        
        public System.Threading.Tasks.Task<mouham_cWpfMedecin.ServicePatient.Patient[]> GetListPatientAsync() {
            return base.Channel.GetListPatientAsync();
        }
        
        public mouham_cWpfMedecin.ServicePatient.Patient GetPatient(int id) {
            return base.Channel.GetPatient(id);
        }
        
        public System.Threading.Tasks.Task<mouham_cWpfMedecin.ServicePatient.Patient> GetPatientAsync(int id) {
            return base.Channel.GetPatientAsync(id);
        }
        
        public bool AddPatient(mouham_cWpfMedecin.ServicePatient.Patient user) {
            return base.Channel.AddPatient(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddPatientAsync(mouham_cWpfMedecin.ServicePatient.Patient user) {
