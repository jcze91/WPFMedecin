...
namespace mouham_cWpfMedecin.PatientServiceReference {
    ...
    public partial class Patient : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private mouham_cWpfMedecin.PatientServiceReference.Observation[] ObservationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public mouham_cWpfMedecin.PatientServiceReference.Observation[] Observations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="PatientServiceReference.IServicePatient")]
    public interface IServicePatient {
        ...
        mouham_cWpfMedecin.PatientServiceReference.Patient[] GetListPatient();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetListPatient", ReplyAction="http://tempuri.org/IServicePatient/GetListPatientResponse")]
        System.Threading.Tasks.Task<mouham_cWpfMedecin.PatientServiceReference.Patient[]> GetListPatientAsync();
        ...
        mouham_cWpfMedecin.PatientServiceReference.Patient GetPatient(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetPatient", ReplyAction="http://tempuri.org/IServicePatient/GetPatientResponse")]
        System.Threading.Tasks.Task<mouham_cWpfMedecin.PatientServiceReference.Patient> GetPatientAsync(int id);
        ...
        bool AddPatient(mouham_cWpfMedecin.PatientServiceReference.Patient user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/AddPatient", ReplyAction="http://tempuri.org/IServicePatient/AddPatientResponse")]
        System.Threading.Tasks.Task<bool> AddPatientAsync(mouham_cWpfMedecin.PatientServiceReference.Patient user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePatientChannel : mouham_cWpfMedecin.PatientServiceReference.IServicePatient, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePatientClient : System.ServiceModel.ClientBase<mouham_cWpfMedecin.PatientServiceReference.IServicePatient>, mouham_cWpfMedecin.PatientServiceReference.IServicePatient {
        ...
        public mouham_cWpfMedecin.PatientServiceReference.Patient[] GetListPatient() {
            return base.Channel.GetListPatient();
        }
        
        public System.Threading.Tasks.Task<mouham_cWpfMedecin.PatientServiceReference.Patient[]> GetListPatientAsync() {
            return base.Channel.GetListPatientAsync();
        }
        
        public mouham_cWpfMedecin.PatientServiceReference.Patient GetPatient(int id) {
            return base.Channel.GetPatient(id);
        }
        
        public System.Threading.Tasks.Task<mouham_cWpfMedecin.PatientServiceReference.Patient> GetPatientAsync(int id) {
            return base.Channel.GetPatientAsync(id);
        }
        
        public bool AddPatient(mouham_cWpfMedecin.PatientServiceReference.Patient user) {
            return base.Channel.AddPatient(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddPatientAsync(mouham_cWpfMedecin.PatientServiceReference.Patient user) {
