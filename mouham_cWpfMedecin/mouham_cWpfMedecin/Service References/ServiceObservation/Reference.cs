...
namespace mouham_cWpfMedecin.ServiceObservation {
    ...
    public interface IServiceObservation {
        ...
        bool AddObservation(int idPatient, mouham_cWpfMedecin.ServiceObservation.Observation obs);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceObservation/AddObservation", ReplyAction="http://tempuri.org/IServiceObservation/AddObservationResponse")]
        System.Threading.Tasks.Task<bool> AddObservationAsync(int idPatient, mouham_cWpfMedecin.ServiceObservation.Observation obs);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceObservationChannel : mouham_cWpfMedecin.ServiceObservation.IServiceObservation, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceObservationClient : System.ServiceModel.ClientBase<mouham_cWpfMedecin.ServiceObservation.IServiceObservation>, mouham_cWpfMedecin.ServiceObservation.IServiceObservation {
        ...
        public bool AddObservation(int idPatient, mouham_cWpfMedecin.ServiceObservation.Observation obs) {
            return base.Channel.AddObservation(idPatient, obs);
        }
        
        public System.Threading.Tasks.Task<bool> AddObservationAsync(int idPatient, mouham_cWpfMedecin.ServiceObservation.Observation obs) {
