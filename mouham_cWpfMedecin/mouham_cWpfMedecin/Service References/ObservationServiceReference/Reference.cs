...
namespace mouham_cWpfMedecin.ObservationServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ObservationServiceReference.IServiceObservation")]
    public interface IServiceObservation {
        ...
        bool AddObservation(int idPatient, mouham_cWpfMedecin.ObservationServiceReference.Observation obs);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceObservation/AddObservation", ReplyAction="http://tempuri.org/IServiceObservation/AddObservationResponse")]
        System.Threading.Tasks.Task<bool> AddObservationAsync(int idPatient, mouham_cWpfMedecin.ObservationServiceReference.Observation obs);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceObservationChannel : mouham_cWpfMedecin.ObservationServiceReference.IServiceObservation, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceObservationClient : System.ServiceModel.ClientBase<mouham_cWpfMedecin.ObservationServiceReference.IServiceObservation>, mouham_cWpfMedecin.ObservationServiceReference.IServiceObservation {
        ...
        public bool AddObservation(int idPatient, mouham_cWpfMedecin.ObservationServiceReference.Observation obs) {
            return base.Channel.AddObservation(idPatient, obs);
        }
        
        public System.Threading.Tasks.Task<bool> AddObservationAsync(int idPatient, mouham_cWpfMedecin.ObservationServiceReference.Observation obs) {
