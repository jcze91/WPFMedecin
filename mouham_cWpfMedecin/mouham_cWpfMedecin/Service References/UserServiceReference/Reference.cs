...
namespace mouham_cWpfMedecin.UserServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="UserServiceReference.IServiceUser")]
    public interface IServiceUser {
        ...
        mouham_cWpfMedecin.UserServiceReference.User[] GetListUser();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetListUser", ReplyAction="http://tempuri.org/IServiceUser/GetListUserResponse")]
        System.Threading.Tasks.Task<mouham_cWpfMedecin.UserServiceReference.User[]> GetListUserAsync();
        ...
        mouham_cWpfMedecin.UserServiceReference.User GetUser(string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetUser", ReplyAction="http://tempuri.org/IServiceUser/GetUserResponse")]
        System.Threading.Tasks.Task<mouham_cWpfMedecin.UserServiceReference.User> GetUserAsync(string login);
        ...
        bool AddUser(mouham_cWpfMedecin.UserServiceReference.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/AddUser", ReplyAction="http://tempuri.org/IServiceUser/AddUserResponse")]
        System.Threading.Tasks.Task<bool> AddUserAsync(mouham_cWpfMedecin.UserServiceReference.User user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceUserChannel : mouham_cWpfMedecin.UserServiceReference.IServiceUser, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceUserClient : System.ServiceModel.ClientBase<mouham_cWpfMedecin.UserServiceReference.IServiceUser>, mouham_cWpfMedecin.UserServiceReference.IServiceUser {
        ...
        public mouham_cWpfMedecin.UserServiceReference.User[] GetListUser() {
            return base.Channel.GetListUser();
        }
        
        public System.Threading.Tasks.Task<mouham_cWpfMedecin.UserServiceReference.User[]> GetListUserAsync() {
            return base.Channel.GetListUserAsync();
        }
        
        public mouham_cWpfMedecin.UserServiceReference.User GetUser(string login) {
            return base.Channel.GetUser(login);
        }
        
        public System.Threading.Tasks.Task<mouham_cWpfMedecin.UserServiceReference.User> GetUserAsync(string login) {
            return base.Channel.GetUserAsync(login);
        }
        
        public bool AddUser(mouham_cWpfMedecin.UserServiceReference.User user) {
            return base.Channel.AddUser(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddUserAsync(mouham_cWpfMedecin.UserServiceReference.User user) {
